...
#define SERIALIZE_BASIC_TYPEHEADER(type) void serialize(std::ostream&, const type&); void deserialize(std::istream&, type&);
namespace serial {
    ...
    void serialize(std::ostream&, const std::string&);
    ...
    template<typename type>void canSerialize(const type& obj) {
        serial::internal::canSerialize(obj);
    }
    template<typename type>void canDeserialize(type& obj) {
        serial::internal::canDeserialize(obj);
    }
}
#define SERIALIZE_BASIC_TYPE(type) void serial::serialize(std::ostream& os, const type& obj) {os << obj;} void serial::deserialize(std::istream& is, type& obj) {is >> obj;}
...
void serial::serialize(std::ostream& os, const std::string& obj) {
...
void serial::deserialize(std::istream& is, std::string& obj) {
    obj = std::string("");
    size_t len = 0;
...
namespace serial {
    ...
    template<typename type> void serialize(std::ostream& os, const std::vector<type>& obj) {
    ...
    template<typename type> void deserialize(std::istream& is, std::vector<type>& obj) {
        size_t vectorSize = 0;
    ...
    template<typename typeA, typename typeB> void serialize(std::ostream& os, const std::pair<typeA, typeB>& obj) {
        serial::internal::serialize(os, obj.first);
        os << " ";
        serial::internal::serialize(os, obj.second);
    }
    template<typename typeA, typename typeB> void deserialize(std::istream& is, std::pair<typeA, typeB>& obj) {
        serial::internal::deserialize(is, obj.first);
        serial::internal::deserialize(is, obj.second);
    }
    template<typename... Args> void serialize(std::ostream& os, const std::tuple<Args...>& obj) {
    ...
    template<typename... Args> void deserialize(std::istream& is, std::tuple<Args...>& obj) {
        std::apply(
            [&is](auto&... args)->void {
...
namespace serial {
    ...
    template<typename type, typename type2, typename... Args> void serialize(std::ostream& os, const type& obj, const type2& obj2, const Args&... args) {
        serial::internal::serialize(os, obj);
        serial::internal::serialize(os, obj2, args...);
    }
    template<typename type, typename type2, typename... Args> void deserialize(std::istream& is, type& obj, type2& obj2, Args&... args) {
        serial::internal::deserialize(is, obj);
        serial::internal::deserialize(is, obj2, args...);
    }
    template<typename... Args> std::string serializeToString(const Args&... args) {
        std::ostringstream str;
        serial::internal::serialize(str, args...);
        return str.str();
    }
    template<typename type> type deserializeFromStream(std::istream& is) {
        type obj;
        serial::internal::deserialize(is, obj);
        return obj;
    }
    template<typename type> type deserializeFromString(const std::string& objstr) {
